...
A field-ready, human-aligned autonomy system for environments where trust must be earned, not assumed.
...
* ⚡ **20 Hz simulation loop** — generates synthetic detections and alerts
* 🧩 **Adaptive thresholds** — clarity + alert-rate feedback loop
* 🪪 **Every change logged** — tamper-resistant SQLite ledger
* ✋ **Human approval/veto** — via `/apply` and `/veto` API endpoints
